  ...
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-[1200px] py-10">
      <div className="wrapper bg-gray-50 dark:bg-medium px-4 py-8 shadow-lg rounded-md sm:px-10">
        <div className="mb-10 text-gray-900 w-full dark:text-gray-50">
          <h1 className="text-3xl font-bold uppercase">
            Get in touch!
          </h1>
          <span>Please allow 24 Hours for a response</span>
          <div className="flex gap-3 w-full items-center mt-2 [&>*]:bg-sky-400">
            <FacebookOutlined className="text-2xl p-1 text-gray-50" />
            <TwitterOutlined className="text-2xl p-1 text-gray-50" />
            <YoutubeOutlined className="text-2xl p-1 text-gray-50" />
            <InstagramOutlined className="text-2xl p-1 text-gray-50" />
          </div>
        </div>
